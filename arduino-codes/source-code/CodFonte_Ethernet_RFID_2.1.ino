...
String UrlServerExecutePHP_1 = "GET /function_database.php?TAG_NFC=";
...
IPAddress server(192, 168, 1, 5); //IPV4 (PC - CMD)
IPAddress ip(192, 168, 1, 78); //(ultimo OCTETO ñ pode ser 1 ou 2)
