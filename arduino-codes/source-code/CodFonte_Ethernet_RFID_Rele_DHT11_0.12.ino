...
IPAddress server(192, 168, 1, 9); //IPV4 (PC - CMD)
IPAddress ip(192, 168, 1, 80); //(ultimo OCTETO ñ pode ser 1 ou 2)
...
void Perifericos(){
  ...
  if(P001Value == 2){
    ...
    irsend.sendNEC(0x10C8E11E, 32); // PROJETOR ACER - LEONARDO 
    delay(50);
  }
  ...
  if(P001Value == 3){
    ...
    delay(600);
    //irsend.sendNEC(0x20DF10EF, 32); // PROJETOR EPSON - SALA COLÉGIO
    irsend.sendNEC(0x10C8E11E, 32); // PROJETOR ACER - LEONARDO - 0x10C8E11E
  }
  ...
  if(P001Value == 4){ //COLOCAR COD HEX DEC. PARA CONGELAR
    ...
    irsend.sendNEC(0x10C8718E, 32); // PROJETOR ACER - LEONARDO - 0x10C8718E
    delay(50);
  }
}
