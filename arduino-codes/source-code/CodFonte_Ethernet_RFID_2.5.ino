...
String UrlServerSerachPHP_1 = "GET /ArduinoPesquisaTeste.php?valV001=";
...
void ChekValuesServer(){
  mensagem = UrlServerSerachPHP_1 + temp01 + UrlServerSerachPHP_1 + temp02 + UrlServerSerachPHP_3 + StatusVentilador01 + UrlServerSerachPHP_4 + StatusVentilador02 + UrlServerSerachPHP_5 + StatusComputador + UrlServerSerachPHP_6 + StatusProjetor;
...
void LeituraDados(){
  EnviaRequisicao("GET /ArduinoPesquisaTeste.php HTTP/1.1\n"
                  "Host: 192.168.1.100\n" // Substitua pelo IP do seu servidor PHP
                  "Connection: close\n"
                  "\n");
